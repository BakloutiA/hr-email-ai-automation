...
![n8n Workflow Canvas](Screenshot_canvas.jpeg)
...
![Data Parsing Success](data-parsing-success.jpeg)
...
Installation Steps
Download the hr-recruitment-automation.json file from this repository root.

Open your n8n workspace dashboard, click the top-right options menu (...), and select Import from file....

Select the downloaded JSON blueprint to populate the node canvas.

Open the Groq Chat Model node, click Create New Credential, and paste your API key.

Re-authenticate your Gmail Trigger and Send a message nodes with your OAuth credentials.

Toggle the workflow to Active to let it listen for inbound applicant requests in real-time.
